...
const roleNavItems: Record<UserRole, NavItem[]> = {
  ...
  support: [
    { path: '/support', icon: '🎧', labelEn: 'KYC Document Desk', labelUr: 'کے وائی سی ڈیسک' },
  ...
  finance: [
    { path: '/finance', icon: '💵', labelEn: 'Revenue & Tax Invoices', labelUr: 'ریونیو اور انوائسنگ' },
    { path: '/dashboard/broker', icon: '🛡️', labelEn: 'Escrow Clearing', labelUr: 'ایسکرو کلئیرنگ' },
    { path: '/admin', icon: '⚙️', labelEn: 'Monetization Rules', labelUr: 'مونیٹائزیشن سیٹنگز' },
  ],
  admin: [
    { path: '/admin', icon: '👑', labelEn: 'Super Admin System', labelUr: 'سپر ایڈمن' },
    ...
    { path: '/support', icon: '🎧', labelEn: 'KYC Verification', labelUr: 'کے وائی سی ڈیسک' },
    { path: '/finance', icon: '💵', labelEn: 'Revenue System', labelUr: 'ریونیو سسٹم' },
